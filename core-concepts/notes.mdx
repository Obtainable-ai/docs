...
- **Ask the assistant** — use the [AI assistant](/features/chat) to pressure-test the draft: what's missing, what's assumed, what a reader will ask.
- **Use the [AI editor](/features/ai-editor)** — proofread or rewrite the whole note, rewrite a selection, or draft a new note from a prompt.

Open a finished note and select **Listen** to [hear it read aloud](/features/listen) — a useful last pass before you share.
...
<Info>
  Want specific people to *edit* with you rather than just read and comment? Add them as [collaborators](/features/collaborators) — that shares the note with the workspace too.
</Info>

New notes follow your [Sharing preference](/features/preferences#sharing) for notes — private unless you've changed the default.
