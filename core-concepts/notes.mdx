...
## Publish a refined note

When a note has been refined to the point where it's worth the whole workspace's attention, publish it:

<Steps>
  <Step title="Open the note and select Publish">
    The publish dialog shows a preview of how the note will appear, including its reading time.
  </Step>
  <Step title="Choose draft visibility">
    Decide whether the working draft stays visible alongside the published note, or whether readers only see the polished result.
  </Step>
  <Step title="Publish">
    The note appears in your workspace's Notes feed for every member to read. If you keep editing afterwards, you can republish to update it.
  </Step>
</Steps>
...
3. **Notes** — thoughts composed into structured thinking, opened to peers and published to the workspace
