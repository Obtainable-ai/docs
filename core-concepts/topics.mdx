---
title: "Topics: automatic clustering of your PeerNotes thoughts"
sidebarTitle: "Topics"
...
- **Topic chips** on thoughts and notes let you jump from any item to everything else on the same theme.
...
<Info>
  Topics span your whole pipeline: filter notes by topic, tag notes with topics, and trace a published note back to the raw thoughts it grew from — all along the same theme.
</Info>