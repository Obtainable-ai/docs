...
<Info>
  Topics span your whole pipeline: filter notes by topic, tag notes with topics, and trace a shared note back to the raw thoughts it grew from — all along the same theme.
</Info>