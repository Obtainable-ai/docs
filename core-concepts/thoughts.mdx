...
<Steps>
  ...
  <Step title="Write or dictate what you're thinking">
    A thought can be a single line or a few paragraphs. Don't polish it — the point is to get the idea down while it's fresh. Prefer to talk it out? Use the microphone button to [dictate the thought](/guides/voice-and-ai#dictate-a-thought).
  </Step>
