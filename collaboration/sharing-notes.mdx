...
By default, every new thought, note, and source is private. If you'd rather share a whole type automatically, set it in [Preferences → Sharing](/configuration/user-preferences#sharing) — independently for **Thoughts**, **Notes**, and **Sources**.
...
Collaborators are notes-only — see [Collaborating on notes](/collaboration/real-time-editing) for how to use them well.
